  ...
  : QDialog(parent)
{
  ...
  if(btnSet == BS_CANCEL_OKAY)
  {
    ...
    addCustomButton("确定",   BB_ACCEPT);
    addCustomButton("取消", BB_REJECT);
  }
...
e.label->setAutoFillBackground(true);
e.label->setStyleSheet("QLabel{background:#000000;}");
...
void CustomDialog::customBtnAccept()
{
  ...
  for(int i = 0; i<(int)elements.size(); i++)
  {
    ...
    case(DLG_LINEEDIT):
      qDebug()<<"............yyyyyyyy"<<e.lineEdit->text();
